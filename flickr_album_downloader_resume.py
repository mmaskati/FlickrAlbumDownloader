...
for line in album_lines:
    ...
    if len(existing_files) >= int(photo_count):
        print(f"✅ Album already complete, skipping: {album_title_clean}")
        continue
    ...
    for i, photo in enumerate(photos):
        ...
        file_path = os.path.join(folder_path, f"{i+1:03d}_{photo_title}.jpg")
